...
function jian$mbtlex$lib$automaton$$TagState$op_equal(_x_224, _x_225) {
  return moonbitlang$core$array$$Array$op_equal$13$(_x_224, _x_225);
}
...
function jian$mbtlex$lib$automaton$$DFA$from_nfa(nfa) {
  ...
  const _env = { _0: nfa, _1: queue, _2: node_map, _3: dfa };
  ...
  _L: while (true) {
    ...
    switch (re$2.$tag) {
      ...
      case 7: {
        ...
        const final_ = jian$mbtlex$lib$automaton$$NFA$register_regex_rec(self$2, node$2, _x$5, name2tag$2);
        jian$mbtlex$lib$automaton$$NFA$add_edge(self$2, node$2, $64$jian$47$mbtlex$47$lib$47$automaton$46$Symbol$Eps, jian$mbtlex$lib$automaton$$NFA$add_edge$46$tag$46$default(), final_);
        return final_;
      }
      case 6: {
        const _Repetition = re$2;
        const _x$6 = _Repetition._0;
        const final_$2 = jian$mbtlex$lib$automaton$$NFA$register_regex_rec(self$2, node$2, _x$6, name2tag$2);
        jian$mbtlex$lib$automaton$$NFA$add_edge(self$2, final_$2, $64$jian$47$mbtlex$47$lib$47$automaton$46$Symbol$Eps, jian$mbtlex$lib$automaton$$NFA$add_edge$46$tag$46$default(), node$2);
        return final_$2;
      }
      case 9: {
        const _Concat = re$2;
...
function jian$mbtlex$lib$automaton$$Symbol$op_equal(_x_98, _x_99) {
  if (_x_98.$tag === 0) {
    if (_x_99.$tag === 0) {
      return true;
    } else {
...
function Yoorkin$trie$$T$add$113$(self, path, value) {
  return Yoorkin$trie$$add$46$aux$47$2889(value, moonbitlang$core$array$$Array$op_as_view$8$(moonbitlang$core$string$$String$to_array(path), 0, undefined), self);
}
function Yoorkin$trie$$add$46$aux$47$2889(value, _param1, _param2) {
  if (moonbitlang$core$array$$ArrayView$length$8$(_param1) === 0) {
    ...
    return { value: _param2.value, forks: moonbitlang$core$immut$sorted_map$$T$add$93$(_param2.forks, _x, Yoorkin$trie$$add$46$aux$47$2889(value, _x$2, subtree)) };
  }
}
