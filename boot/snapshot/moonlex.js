...
function moonbitlang$core$sorted_set$$to_array$46$dfs$47$247(_env, root) {
  const arr = _env._1;
  const i = _env._0;
  let _tmp = root;
  while (true) {
    ...
    if (root$2 === undefined) {
      ...
      const _Some = root$2;
      const _root = _Some;
      moonbitlang$core$sorted_set$$to_array$46$dfs$47$247(_env, _root.left);
...
function moonbitlang$core$sorted_set$$T$to_array$5$(self) {
  if (self.size === 0) {
    ...
    moonbitlang$core$sorted_set$$to_array$46$dfs$47$247(_env, self.root);
    return arr;
  }
}
...
function moonbitlang$core$array$$choose_pivot$46$sort_2$47$276(_env, a, b) {
  const arr = _env._1;
  const swaps = _env._0;
...
function moonbitlang$core$array$$choose_pivot$46$sort_3$47$277(_env, a, b, c) {
  moonbitlang$core$array$$choose_pivot$46$sort_2$47$276(_env, a, b);
  moonbitlang$core$array$$choose_pivot$46$sort_2$47$276(_env, b, c);
  moonbitlang$core$array$$choose_pivot$46$sort_2$47$276(_env, a, b);
}
function moonbitlang$core$array$$choose_pivot$18$(arr) {
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      moonbitlang$core$array$$choose_pivot$46$sort_3$47$277(_env, a - 1 | 0, a, a + 1 | 0);
      moonbitlang$core$array$$choose_pivot$46$sort_3$47$277(_env, b - 1 | 0, b, b + 1 | 0);
      moonbitlang$core$array$$choose_pivot$46$sort_3$47$277(_env, c - 1 | 0, c, c + 1 | 0);
    }
    moonbitlang$core$array$$choose_pivot$46$sort_3$47$277(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function moonbitlang$core$immut$hashmap$$add_with_hash$46$make_leaf$47$860(depth, key, hash, value) {
  if (depth >= 32) {
    return new $64$moonbitlang$47$core$47$immut$47$hashmap$46$T$Leaf$9$(key, value);
  } else {
    const idx = hash & 31;
    const child = moonbitlang$core$immut$hashmap$$add_with_hash$46$make_leaf$47$860(depth + 5 | 0, key, hash >>> 5 | 0, value);
...
function moonbitlang$core$immut$hashmap$$T$add_with_hash$37$(self, key, depth, hash, value) {
  switch (self.$tag) {
    case 0: {
      return moonbitlang$core$immut$hashmap$$add_with_hash$46$make_leaf$47$860(depth, key, hash, value);
    }
    case 1: {
      const _Leaf = self;
      const _key1 = _Leaf._0;
...
function moonbitlang$core$immut$hashmap$$add_with_hash$46$make_leaf$47$885(depth, key, hash, value) {
  if (depth >= 32) {
    return new $64$moonbitlang$47$core$47$immut$47$hashmap$46$T$Leaf$10$(key, value);
  } else {
    const idx = hash & 31;
    const child = moonbitlang$core$immut$hashmap$$add_with_hash$46$make_leaf$47$885(depth + 5 | 0, key, hash >>> 5 | 0, value);
...
function moonbitlang$core$immut$hashmap$$T$add_with_hash$38$(self, key, depth, hash, value) {
  switch (self.$tag) {
    case 0: {
      return moonbitlang$core$immut$hashmap$$add_with_hash$46$make_leaf$47$885(depth, key, hash, value);
    }
    case 1: {
      const _Leaf = self;
      const _key1 = _Leaf._0;
...
function moonbitlang$core$builtin$$println$74$(input) {
  console.log(moonbitlang$core$builtin$$Show$to_string$75$(input));
}
...
function moonbitlang$core$builtin$$Eq$op_equal$19$(self, other) {
  return moonbitlang$core$builtin$$Eq$op_equal$81$(self._0, other._0) && moonbitlang$core$builtin$$Eq$op_equal$82$(self._1, other._1);
}
...
function moonbitlang$core$builtin$$Div$op_div$84$(self, other) {
...
function moonbitlang$core$builtin$$Div$op_div$3$(self, other) {
  return moonbitlang$core$builtin$$Div$op_div$84$(self, other);
}
...
function moonbitlang$core$builtin$$Sub$op_sub$84$(self, other) {
...
function moonbitlang$core$builtin$$Sub$op_sub$3$(self, other) {
  return moonbitlang$core$builtin$$Sub$op_sub$84$(self, other);
}
  ...
  if (length >= 0) {
    if (value <= 65535) {
      ...
      while (true) {
        const _ = _tmp;
        if (_ < length) {
          moonbitlang$core$builtin$$Logger$write_char$10$(buf, value);
          _tmp = _ + 1 | 0;
          continue;
        } else {
          break;
...
function moonbitlang$core$builtin$$Add$op_add$84$(self, other) {
  return moonbitlang$core$builtin$$MyInt64$add_hi_lo(self, other.hi, other.lo);
}
function moonbitlang$core$builtin$$Add$op_add$3$(self, other) {
  return moonbitlang$core$builtin$$Add$op_add$84$(self, other);
}
...
function moonbitlang$core$builtin$$Hash$hash_combine$83$(self, hasher) {
  const _a = self._0;
  const _b = self._1;
...
function moonbitlang$core$builtin$$Map$new$46$capacity$46$default$87$() {
  return 8;
}
...
function moonbitlang$core$array$$Array$each$77$(self, f) {
...
function moonbitlang$core$builtin$$Map$from_array$45$(arr) {
  ...
  moonbitlang$core$array$$Array$each$77$(arr, (e) => {
...
function moonbitlang$core$builtin$$Map$from_array$89$(arr) {
  const m = moonbitlang$core$builtin$$Map$new$89$(arr.length);
  moonbitlang$core$array$$Array$each$95$(arr, (e) => {
    moonbitlang$core$builtin$$Map$set$89$(m, e._0, e._1);
  });
  return m;
}
...
function moonbitlang$core$builtin$$Map$get$87$(self, key) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _entry = _Some;
      if (_entry.hash === hash && moonbitlang$core$builtin$$Eq$op_equal$85$(_entry.key, key)) {
        return _entry.value;
      }
      if (i > _entry.psl) {
        return undefined;
...
function moonbitlang$core$builtin$$Map$size$92$(self) {
  return self.size;
}
function moonbitlang$core$array$$FixedArray$fill$107$(self, value) {
...
function moonbitlang$core$builtin$$Map$clear$0$(self) {
  moonbitlang$core$array$$FixedArray$fill$107$(self.entries, undefined);
  self.size = 0;
  self.head = undefined;
  self.tail = undefined;
}
...
function moonbitlang$core$builtin$$Iter$new$94$(f) {
  return f;
}
...
function moonbitlang$core$builtin$$Iter$new$1$(f) {
  return f;
}
function moonbitlang$core$builtin$$Map$iter$88$(self) {
  return moonbitlang$core$builtin$$Iter$new$94$((yield_) => {
    let _tmp = self.head;
    while (true) {
      const _param = _tmp;
      if (_param === undefined) {
...
function moonbitlang$core$builtin$$Iter2$new$91$(f) {
  return f;
}
function moonbitlang$core$builtin$$Map$iter2$91$(self) {
  return moonbitlang$core$builtin$$Iter2$new$91$((yield_) => {
    let _tmp = self.head;
    while (true) {
      const _param = _tmp;
      if (_param === undefined) {
...
function moonbitlang$core$builtin$$Map$from_iter$93$(iter) {
  const m = moonbitlang$core$builtin$$Map$from_array$93$([]);
  iter((e) => {
    moonbitlang$core$builtin$$Map$set$93$(m, e._0, e._1);
    return 1;
  });
...
function moonbitlang$core$builtin$$Show$to_string$75$(self) {
  ...
  moonbitlang$core$builtin$$Show$output$74$(self, { self: logger, method_0: moonbitlang$core$builtin$$Logger$write_string$10$, method_1: moonbitlang$core$builtin$$Logger$write_substring$10$, method_2: moonbitlang$core$builtin$$Logger$write_char$10$ });
  return moonbitlang$core$builtin$$StringBuilder$to_string(logger);
}
function moonbitlang$core$builtin$$Mul$op_mul$84$(self, other) {
  const _ahi = self.hi;
  const _alo = self.lo;
  const _bhi = other.hi;
  const _blo = other.lo;
...
function moonbitlang$core$builtin$$Mul$op_mul$3$(self, other) {
  return moonbitlang$core$builtin$$Mul$op_mul$84$(self, other);
}
...
function moonbitlang$core$builtin$$Eq$op_equal$51$(self, other) {
  ...
  if (self_len === other_len) {
    ...
    while (true) {
      const i = _tmp;
      if (i < self_len) {
        if (moonbitlang$core$builtin$$Eq$op_equal$122$(self[i], other[i])) {
        } else {
          return false;
        }
        _tmp = i + 1 | 0;
...
function moonbitlang$core$builtin$$Eq$op_equal$123$(self, other) {
  const self_len = self.length;
  const other_len = other.length;
  if (self_len === other_len) {
    let _tmp = 0;
...
function moonbitlang$core$builtin$$Compare$compare$51$(self, other) {
  ...
  if (cmp === 0) {
    ...
    while (true) {
      const i = _tmp;
      if (i < len_self) {
        const cmp$2 = moonbitlang$core$builtin$$Compare$compare$122$(self[i], other[i]);
        if (cmp$2 === 0) {
        } else {
          return cmp$2;
        }
...
function moonbitlang$core$builtin$$Compare$compare$123$(self, other) {
  const len_self = self.length;
  const len_other = other.length;
  const cmp = $compare_int(len_self, len_other);
  if (cmp === 0) {
...
function moonbitlang$core$builtin$$Compare$compare$19$(self, other) {
  const t0 = moonbitlang$core$builtin$$Compare$compare$81$(self._0, other._0);
  return t0 === 0 ? moonbitlang$core$builtin$$Compare$compare$82$(self._1, other._1) : t0;
}
...
function moonbitlang$core$builtin$$Compare$compare$82$(self, other) {
  const t0 = $compare_int(self._0, other._0);
...
function moonbitlang$core$builtin$$Iter$run$111$(self, f) {
  const _func = self;
  return _func(f);
}
...
function moonbitlang$core$builtin$$Iter$filter_map$125$(self, f) {
...
function moonbitlang$core$builtin$$Iter$to_array$109$(self) {
  const result = [];
  self((e) => {
    moonbitlang$core$array$$Array$push$109$(result, e);
    return 1;
  });
  return result;
}
function moonbitlang$core$builtin$$Iter$to_array$97$(self) {
  const result = [];
  self((e) => {
    moonbitlang$core$array$$Array$push$97$(result, e);
    return 1;
  });
  return result;
}
...
function moonbitlang$core$builtin$$Iter$join(self, sep) {
  ...
  self((str) => {
    if (first.val) {
      ...
      moonbitlang$core$builtin$$Logger$write_string$10$(buf, sep);
    }
    moonbitlang$core$builtin$$Logger$write_string$10$(buf, str);
    return 1;
  });
  return moonbitlang$core$builtin$$StringBuilder$to_string(buf);
}
...
function moonbitlang$ulex$lib$util$diet$$InorderIterator$move_left$1$(self, node) {
  ...
  while (true) {
    ...
    if (_param.$tag === 0) {
      ...
      const _Node = _param;
      const _left = _Node._0;
      moonbitlang$core$array$$Array$push$115$(self, _Node);
      _tmp = _left;
      continue;
    }
  }
...
function moonbitlang$ulex$lib$util$diet$$InorderIterator$next$1$(self) {
  const _bind = moonbitlang$core$array$$Array$pop$115$(self);
  if (_bind === undefined) {
    return undefined;
  } else {
    const _Some = _bind;
  ...
  while (true) {
    ...
    if (_param === undefined) {
      ...
      if (_param$2 === undefined) {
        ...
        const _b = _Some$2;
        if (moonbitlang$core$builtin$$Eq$op_equal$83$(_a, _b)) {
...
function moonbitlang$ulex$lib$util$diet$$Tree$iter_intervals$1$(self) {
  return moonbitlang$core$builtin$$Iter$new$111$((yield_) => {
    if (self.$tag === 0) {
      ...
      const _Node = self;
      const _bind = moonbitlang$core$builtin$$Iter$run$111$(moonbitlang$ulex$lib$util$diet$$Tree$iter_intervals$1$(_Node._0), yield_);
      if (_bind === 1) {
        const _bind$2 = yield_({ _0: _Node._3, _1: _Node._4 });
        if (_bind$2 === 1) {
          const _bind$3 = moonbitlang$core$builtin$$Iter$run$111$(moonbitlang$ulex$lib$util$diet$$Tree$iter_intervals$1$(_Node._1), yield_);
          if (_bind$3 === 1) {
            return 1;
          } else {
            return 0;
...
function moonbitlang$core$builtin$$Hash$hash_combine$126$(self, hasher) {
  const _bind = moonbitlang$ulex$lib$util$diet$$Tree$iter_intervals$1$(self);
  _bind((interval) => {
    moonbitlang$core$builtin$$Hash$hash_combine$83$(interval, hasher);
    return 1;
  });
}
function moonbitlang$ulex$lib$util$diet$$Tree$iter$1$(self) {
  const _bind = moonbitlang$ulex$lib$util$diet$$Tree$iter_intervals$1$(self);
...
function moonbitlang$core$builtin$$Eq$op_equal$85$(_x_55, _x_56) {
  return moonbitlang$core$builtin$$Eq$op_equal$126$(_x_55, _x_56);
}
function moonbitlang$core$builtin$$Hash$hash_combine$85$(_x_47, _x_48) {
  moonbitlang$core$builtin$$Hash$hash_combine$126$(_x_47, _x_48);
}
...
function moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$iter(self) {
  return moonbitlang$ulex$lib$util$diet$$Tree$iter$1$(self);
}
...
function moonbitlang$ulex$lib$type$$Regex$get_capture_names(self) {
  ...
  const result = moonbitlang$core$builtin$$Iter$to_array$97$((_p) => _bind((_p$2) => {
  ...
  if (moonbitlang$core$builtin$$Map$size$92$(moonbitlang$core$builtin$$Map$from_array$92$(result)) !== result.length) {
...
function moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(self) {
  const _x = self;
  const _class = _x._0;
  const _lexbuf = _x._1;
...
function moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(self) {
  const _x = self;
  const _class = _x._0;
  const _lexbuf = _x._1;
...
function moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$reset$127$(self, pos) {
  const _x = self;
  const _class = _x._0;
  const _lexbuf = _x._1;
...
function moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$unsafe_get$127$(self, pos) {
  const _x = self;
  const _class = _x._0;
  const _lexbuf = _x._1;
...
function moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(self, start, end) {
  const _x = self;
  const _class = _x._0;
  const _lexbuf = _x._1;
...
function moonbitlang$core$builtin$$Show$output$74$(_x_741, _x_742) {
  ...
  moonbitlang$core$builtin$$Logger$write_object$59$(_x_742, _$42$arg_743);
  ...
  moonbitlang$core$builtin$$Logger$write_object$60$(_self, _$42$arg_745);
  _self.method_0(_self.self, ")");
}
function moonbitlang$core$builtin$$Show$output$59$(_x_723, _x_724) {
  switch (_x_723.$tag) {
    case 0: {
    ...
    case 24: {
      ...
      moonbitlang$core$builtin$$Logger$write_object$11$(_x_724, _$42$arg_730);
      _x_724.method_0(_x_724.self, ")");
      return;
    }
    default: {
...
function moonbitlang$ulex$lib$parser$$code_rbrace$128$(buffer, lexbuf) {
  let _tmp = buffer;
  let _tmp$2 = lexbuf;
  _L: while (true) {
    const buffer$2 = _tmp;
    ...
    const _tag_6 = { val: -1 };
    const _tag_7 = { val: -1 };
    _tag_0.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
    _tag_2.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
    _tag_4.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
    _tag_6.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
    while (true) {
      if (state !== -1) {
        const _bind = state;
        switch (_bind) {
          case 0: {
            const _bind$2 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c;
            if (_bind$2 === -1) {
              c = -1;
            } else {
            ...
            if (c === -1) {
              ...
              if (0 <= c && c <= 33) {
                _tag_7.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
                _tmp$3 = 6;
              } else {
                if (c === 34) {
                  _tag_7.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
          ...
          case 1: {
            _L$2: {
              ...
              matched.val = { _0: 6, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          }
          case 2: {
            _L$3: {
              ...
              matched.val = { _0: 3, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 3: {
            _L$4: {
              ...
              matched.val = { _0: 4, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 4: {
            _L$5: {
              ...
              matched.val = { _0: 5, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_6.val, _1: _tag_7.val }] };
            }
            const _bind$3 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$2;
            if (_bind$3 === -1) {
              c$2 = -1;
            } else {
          ...
          case 5: {
            ...
            const _bind$4 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$3;
            if (_bind$4 === -1) {
              c$3 = -1;
            } else {
          ...
          case 7: {
            ...
            const _bind$5 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$4;
            if (_bind$5 === -1) {
              c$4 = -1;
            } else {
            ...
            if (0 <= c$4 && c$4 <= 33) {
              ...
              if (c$4 === 34) {
                _tag_3.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
                _tmp$5 = 10;
              } else {
                if (35 <= c$4 && c$4 <= 91) {
                  _tmp$5 = 11;
          ...
          case 8: {
            const _bind$6 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$5;
            if (_bind$6 === -1) {
              c$5 = -1;
            } else {
          ...
          case 9: {
            const _bind$7 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$6;
            if (_bind$7 === -1) {
              c$6 = -1;
            } else {
            ...
            let _tmp$6;
            if (c$6 === 39) {
              _tag_5.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
              _tmp$6 = 14;
            } else {
              _tmp$6 = -1;
            }
          ...
          case 10: {
            _L$9: {
              ...
              matched.val = { _0: 1, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_2.val, _1: _tag_3.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 11: {
            const _bind$8 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$7;
            if (_bind$8 === -1) {
              c$7 = -1;
            } else {
          ...
          case 12: {
            const _bind$9 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$8;
            if (_bind$9 === -1) {
              c$8 = -1;
            } else {
          ...
          case 13: {
            const _bind$10 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$9;
            if (_bind$10 === -1) {
              c$9 = -1;
            } else {
            ...
            if (0 <= c$9 && c$9 <= 9) {
              ...
              if (c$9 === 10) {
                _tag_1.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
                _tmp$8 = 16;
              } else {
          ...
          case 14: {
            _L$10: {
              ...
              matched.val = { _0: 2, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_4.val, _1: _tag_5.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 15: {
            const _bind$11 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$10;
            if (_bind$11 === -1) {
              c$10 = -1;
            } else {
          ...
          case 16: {
            _L$11: {
              ...
              matched.val = { _0: 0, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_0.val, _1: _tag_1.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
    ...
    if (_bind === undefined) {
      ...
      moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$reset$127$(lexbuf$2, _marked_pos);
      switch (_pattern_id) {
        case 0: {
          const _bind$2 = moonbitlang$core$array$$Array$op_get$77$(__captures, 0);
          const __start_pos_of_t = _bind$2._0;
          const __end_pos_of_t = _bind$2._1;
          const t = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t, __end_pos_of_t);
          moonbitlang$core$builtin$$Logger$write_string$10$(buffer$2, t);
          continue _L;
        }
        case 1: {
          const _bind$3 = moonbitlang$core$array$$Array$op_get$77$(__captures, 0);
          const __start_pos_of_t$2 = _bind$3._0;
          const __end_pos_of_t$2 = _bind$3._1;
          const t$2 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t$2, __end_pos_of_t$2);
          moonbitlang$core$builtin$$Logger$write_string$10$(buffer$2, t$2);
          continue _L;
        }
        case 2: {
          const _bind$4 = moonbitlang$core$array$$Array$op_get$77$(__captures, 0);
          const __start_pos_of_t$3 = _bind$4._0;
          const __end_pos_of_t$3 = _bind$4._1;
          const t$3 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t$3, __end_pos_of_t$3);
          moonbitlang$core$builtin$$Logger$write_string$10$(buffer$2, t$3);
          continue _L;
        }
        case 3: {
          moonbitlang$core$builtin$$Logger$write_string$10$(buffer$2, "{");
          moonbitlang$ulex$lib$parser$$code_rbrace$128$(buffer$2, lexbuf$2);
          moonbitlang$core$builtin$$Logger$write_string$10$(buffer$2, "}");
          continue _L;
        }
        case 4: {
        ...
        case 5: {
          const _start_pos_of_t = moonbitlang$core$array$$Array$op_get$77$(__captures, 0)._0;
          const t$4 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$unsafe_get$127$(lexbuf$2, _start_pos_of_t);
...
function moonbitlang$ulex$lib$parser$$string_inner_rquote$128$(buffer, lexbuf) {
  let _tmp = buffer;
  let _tmp$2 = lexbuf;
  _L: while (true) {
    const buffer$2 = _tmp;
        ...
        switch (_bind) {
          ...
          case 1: {
            _L$2: {
              ...
              matched.val = { _0: 11, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_6.val, _1: _tag_7.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 2: {
            _L$3: {
              ...
              matched.val = { _0: 12, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 3: {
            _L$4: {
              ...
              matched.val = { _0: 0, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 7: {
            _L$7: {
              ...
              matched.val = { _0: 7, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 9: {
            _L$8: {
              ...
              matched.val = { _0: 5, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 12: {
            _L$11: {
              ...
              matched.val = { _0: 2, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 13: {
            _L$12: {
              ...
              matched.val = { _0: 1, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 20: {
            _L$13: {
              ...
              matched.val = { _0: 8, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_0.val, _1: _tag_1.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 21: {
            const _bind$12 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$11;
            if (_bind$12 === -1) {
              c$11 = -1;
            } else {
          ...
          case 22: {
            const _bind$13 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$12;
            if (_bind$13 === -1) {
              c$12 = -1;
            } else {
          ...
          case 23: {
            _L$14: {
              ...
              matched.val = { _0: 10, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_4.val, _1: _tag_5.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 24: {
            const _bind$14 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$13;
            if (_bind$14 === -1) {
              c$13 = -1;
            } else {
          ...
          case 25: {
            _L$15: {
              ...
              matched.val = { _0: 9, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_2.val, _1: _tag_3.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
...
function moonbitlang$ulex$lib$parser$$token$128$(lexbuf) {
  let _tmp = lexbuf;
  _L: while (true) {
    const lexbuf$2 = _tmp;
    const matched = { val: undefined };
    ...
    const _tag_12 = { val: -1 };
    const _tag_13 = { val: -1 };
    _tag_12.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
    while (true) {
      if (state !== -1) {
        const _bind = state;
        switch (_bind) {
            ...
            if (c === -1) {
              ...
              if (9 <= c && c <= 10) {
                ...
                switch (c) {
                  ...
                  case 95: {
                    _tag_13.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
                    _tmp$2 = 16;
                    break;
                  }
                  default: {
          ...
          case 1: {
            _L$2: {
              ...
              matched.val = { _0: 18, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 2: {
            _L$3: {
              ...
              matched.val = { _0: 34, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_12.val, _1: _tag_13.val }] };
            }
            const _bind$3 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$2;
            if (_bind$3 === -1) {
          ...
          case 3: {
            _L$4: {
              ...
              matched.val = { _0: 8, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 4: {
            _L$5: {
              ...
              matched.val = { _0: 14, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 5: {
            _L$6: {
              ...
              matched.val = { _0: 10, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 8: {
            _L$9: {
              ...
              matched.val = { _0: 33, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 10: {
            _L$11: {
              ...
              matched.val = { _0: 13, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            const _bind$6 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$5;
            if (_bind$6 === -1) {
          ...
          case 11: {
            _L$12: {
              ...
              matched.val = { _0: 11, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 14: {
            _L$15: {
              ...
              matched.val = { _0: 15, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 15: {
            _L$16: {
              ...
              matched.val = { _0: 21, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 17: {
            _L$18: {
              ...
              matched.val = { _0: 9, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 18: {
            _L$19: {
              ...
              matched.val = { _0: 20, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 20: {
            _L$20: {
              ...
              matched.val = { _0: 17, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 22: {
            _L$22: {
              ...
              matched.val = { _0: 19, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 24: {
            _L$23: {
              ...
              matched.val = { _0: 16, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 30: {
            const _bind$15 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$14;
            if (_bind$15 === -1) {
              c$14 = -1;
            } else {
            ...
            switch (c$14) {
              ...
              case 117: {
                _tag_8.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
                _tmp$15 = 38;
                break;
              }
              case 118: {
          ...
          case 31: {
            ...
            const _bind$16 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$15;
            if (_bind$16 === -1) {
              c$15 = -1;
            } else {
          ...
          case 32: {
            ...
            const _bind$17 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$16;
            if (_bind$17 === -1) {
              c$16 = -1;
            } else {
          ...
          case 33: {
            ...
            const _bind$18 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$17;
            if (_bind$18 === -1) {
              c$17 = -1;
            } else {
          ...
          case 34: {
            _L$31: {
              ...
              matched.val = { _0: 22, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_4.val, _1: _tag_5.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 35: {
            const _bind$19 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$18;
            if (_bind$19 === -1) {
              c$18 = -1;
            } else {
          ...
          case 36: {
            const _bind$20 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$19;
            if (_bind$20 === -1) {
              c$19 = -1;
            } else {
          ...
          case 37: {
            const _bind$21 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$20;
            if (_bind$21 === -1) {
              c$20 = -1;
            } else {
          ...
          case 38: {
            const _bind$22 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$21;
            if (_bind$22 === -1) {
              c$21 = -1;
            } else {
            ...
            if (48 <= c$21 && c$21 <= 57) {
              ...
              if (65 <= c$21 && c$21 <= 70) {
                ...
                if (97 <= c$21 && c$21 <= 102) {
                  ...
                  if (c$21 === 123) {
                    _tag_10.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
                    _tmp$21 = 52;
                  } else {
                    _tmp$21 = -1;
                  }
          ...
          case 39: {
            const _bind$23 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$22;
            if (_bind$23 === -1) {
              c$22 = -1;
            } else {
          ...
          case 40: {
            const _bind$24 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$23;
            if (_bind$24 === -1) {
              c$23 = -1;
            } else {
          ...
          case 41: {
            const _bind$25 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$24;
            if (_bind$25 === -1) {
              c$24 = -1;
            } else {
          ...
          case 42: {
            const _bind$26 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$25;
            if (_bind$26 === -1) {
              c$25 = -1;
            } else {
          ...
          case 43: {
            const _bind$27 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$26;
            if (_bind$27 === -1) {
              c$26 = -1;
            } else {
          ...
          case 45: {
            ...
            const _bind$28 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$27;
            if (_bind$28 === -1) {
              c$27 = -1;
            } else {
          ...
          case 46: {
            ...
            const _bind$29 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$28;
            if (_bind$29 === -1) {
              c$28 = -1;
            } else {
          ...
          case 47: {
            ...
            const _bind$30 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$29;
            if (_bind$30 === -1) {
              c$29 = -1;
            } else {
          ...
          case 48: {
            const _bind$31 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$30;
            if (_bind$31 === -1) {
              c$30 = -1;
            } else {
          ...
          case 49: {
            _L$36: {
              ...
              matched.val = { _0: 25, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 50: {
            _L$37: {
              ...
              matched.val = { _0: 23, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 51: {
            const _bind$32 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$31;
            if (_bind$32 === -1) {
              c$31 = -1;
            } else {
          ...
          case 52: {
            const _bind$33 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$32;
            if (_bind$33 === -1) {
              c$32 = -1;
            } else {
            ...
            let _tmp$31;
            if (48 <= c$32 && c$32 <= 57) {
              _tag_11.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
              _tmp$31 = 62;
            } else {
              if (65 <= c$32 && c$32 <= 70) {
                _tag_11.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
          ...
          case 53: {
            _L$38: {
              ...
              matched.val = { _0: 27, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 54: {
            _L$39: {
              ...
              matched.val = { _0: 29, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 55: {
            _L$40: {
              ...
              matched.val = { _0: 24, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 56: {
            _L$41: {
              ...
              matched.val = { _0: 26, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 57: {
            _L$42: {
              ...
              matched.val = { _0: 28, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 58: {
            const _bind$34 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$33;
            if (_bind$34 === -1) {
              c$33 = -1;
            } else {
          ...
          case 59: {
            ...
            const _bind$35 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$34;
            if (_bind$35 === -1) {
              c$34 = -1;
            } else {
          ...
          case 60: {
            const _bind$36 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$35;
            if (_bind$36 === -1) {
              c$35 = -1;
            } else {
          ...
          case 61: {
            const _bind$37 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$36;
            if (_bind$37 === -1) {
              c$36 = -1;
            } else {
          ...
          case 62: {
            const _bind$38 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$37;
            if (_bind$38 === -1) {
              c$37 = -1;
            } else {
          ...
          case 63: {
            const _bind$39 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$38;
            if (_bind$39 === -1) {
              c$38 = -1;
            } else {
          ...
          case 65: {
            const _bind$40 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$39;
            if (_bind$40 === -1) {
              c$39 = -1;
            } else {
          ...
          case 66: {
            _L$45: {
              ...
              matched.val = { _0: 30, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_6.val, _1: _tag_7.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 67: {
            const _bind$41 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$40;
            if (_bind$41 === -1) {
              c$40 = -1;
            } else {
            ...
            let _tmp$38;
            if (48 <= c$40 && c$40 <= 57) {
              _tag_9.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
              _tmp$38 = 71;
            } else {
              if (65 <= c$40 && c$40 <= 70) {
                _tag_9.val = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2);
          ...
          case 68: {
            const _bind$42 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$41;
            if (_bind$42 === -1) {
              c$41 = -1;
            } else {
          ...
          case 69: {
            const _bind$43 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$42;
            if (_bind$43 === -1) {
              c$42 = -1;
            } else {
          ...
          case 70: {
            const _bind$44 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$43;
            if (_bind$44 === -1) {
              c$43 = -1;
            } else {
          ...
          case 71: {
            const _bind$45 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$44;
            if (_bind$45 === -1) {
              c$44 = -1;
            } else {
          ...
          case 72: {
            _L$46: {
              ...
              matched.val = { _0: 32, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_10.val, _1: _tag_11.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 73: {
            _L$47: {
              ...
              matched.val = { _0: 3, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_0.val, _1: _tag_1.val }, { _0: _tag_2.val, _1: _tag_3.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
          ...
          case 74: {
            const _bind$46 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$45;
            if (_bind$46 === -1) {
              c$45 = -1;
            } else {
          ...
          case 75: {
            const _bind$47 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            let c$46;
            if (_bind$47 === -1) {
              c$46 = -1;
            } else {
          ...
          case 76: {
            _L$48: {
              ...
              matched.val = { _0: 31, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_8.val, _1: _tag_9.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
    ...
    if (_bind === undefined) {
      ...
      switch (_pattern_id) {
        ...
        case 3: {
          ...
          const t1 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t1, __end_pos_of_t1);
          const _bind$3 = moonbitlang$core$array$$Array$op_get$77$(__captures, 1);
          const __start_pos_of_t2 = _bind$3._0;
          const __end_pos_of_t2 = _bind$3._1;
          const t2 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t2, __end_pos_of_t2);
        ...
        case 7: {
          ...
          moonbitlang$ulex$lib$parser$$code_rbrace$128$(buffer, lexbuf$2);
        ...
        case 22: {
          const _start_pos_of_t = moonbitlang$core$array$$Array$op_get$77$(__captures, 0)._0;
          const t = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$unsafe_get$127$(lexbuf$2, _start_pos_of_t);
        ...
        case 30: {
          ...
          const t$2 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t, __end_pos_of_t);
        ...
        case 31: {
          const _bind$5 = moonbitlang$core$array$$Array$op_get$77$(__captures, 0);
          const __start_pos_of_t$2 = _bind$5._0;
          const __end_pos_of_t$2 = _bind$5._1;
          const t$3 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t$2, __end_pos_of_t$2);
        ...
        case 32: {
          const _bind$6 = moonbitlang$core$array$$Array$op_get$77$(__captures, 0);
          const __start_pos_of_t$3 = _bind$6._0;
          const __end_pos_of_t$3 = _bind$6._1;
          const t$4 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t$3, __end_pos_of_t$3);
        ...
        case 33: {
          ...
          moonbitlang$ulex$lib$parser$$string_inner_rquote$128$(buffer$2, lexbuf$2);
        ...
        case 34: {
          const _bind$7 = moonbitlang$core$array$$Array$op_get$77$(__captures, 0);
          const __start_pos_of_t$4 = _bind$7._0;
          const __end_pos_of_t$4 = _bind$7._1;
          const t$5 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t$4, __end_pos_of_t$4);
          switch (t$5) {
            case "eof": {
...
function moonbitlang$ulex$lib$parser$$yy_parse$129$(read_token, start_pos, start, return_) {
    ...
    _L: {
      _L$2: {
        switch (decision.$tag) {
          ...
          default: {
            const _bind$4 = moonbitlang$core$option$$Option$unwrap$104$(lookahead);
            const _x = _bind$4._1;
...
function moonbitlang$ulex$lib$parser$$yy_action_38(_last_pos, _args) {
  ...
  if (_bind.$tag === 4) {
    const _YYObj_String = _bind;
    const __dollar1 = _YYObj_String._0;
    return new Error$moonbitlang$47$ulex$47$lib$47$parser$46$YYObj__type_Regex$46$YYObj__type_Regex(moonbitlang$core$option$$Option$unwrap$106$(moonbitlang$core$builtin$$Map$get$0$(moonbitlang$ulex$lib$parser$$named_regexes, __dollar1)));
  } else {
    return $panic();
  }
}
...
function moonbitlang$ulex$lib$parser$$lex_eoi(read_token, start_pos) {
  return moonbitlang$ulex$lib$parser$$yy_parse$129$(read_token, start_pos, moonbitlang$ulex$lib$parser$$yy_state_41, (_param1) => {
    if (_param1.$tag === 6) {
...
function moonbitlang$ulex$lib$parser$$parse_lex_from_string(input) {
  ...
  return moonbitlang$ulex$lib$parser$$lex_eoi(() => {
    const tok = moonbitlang$ulex$lib$parser$$token$128$(lexbuf);
...
function moonbitlang$x$encoding$$encode(encoding, src) {
  ...
  switch (encoding) {
    ...
    default: {
      write = moonbitlang$core$builtin$$abort$68$("unreachable");
    }
  }
...
function moonbitlang$core$builtin$$Eq$op_equal$44$(_x_287, _x_288) {
  return moonbitlang$core$builtin$$Eq$op_equal$123$(_x_287, _x_288);
}
...
function moonbitlang$core$builtin$$Compare$compare$44$(self, other) {
  return moonbitlang$core$builtin$$Compare$compare$123$(self, other);
}
...
function moonbitlang$ulex$lib$automaton$$DFA$new(code_blocks, captures, start_action) {
  const _bind = [];
  const _bind$2 = moonbitlang$core$builtin$$Map$new$90$(moonbitlang$core$builtin$$Map$new$46$capacity$46$default$90$());
...
function moonbitlang$ulex$lib$automaton$$DFA$new_node(self) {
  ...
  moonbitlang$core$array$$Array$push$79$(self.graph, []);
  return id;
}
function moonbitlang$ulex$lib$automaton$$DFA$add_edge(self, from, e, action, to) {
  moonbitlang$core$array$$Array$push$114$(moonbitlang$core$array$$Array$op_get$79$(self.graph, from), { _0: e, _1: { _0: to, _1: action } });
}
...
function moonbitlang$ulex$lib$automaton$$DFA$register_node(self, nfa, node, os) {
  const code_blocks = moonbitlang$core$builtin$$Iter$collect$5$(moonbitlang$core$builtin$$Iter$filter_map$125$(moonbitlang$core$immut$hashmap$$T$iter$37$(os), (x) => moonbitlang$core$builtin$$Map$get$45$(nfa.end_nodes, x._0.num)));
  if (!moonbitlang$core$array$$Array$is_empty$5$(code_blocks)) {
    ...
    if (end_nodes.length === 1) {
      ...
      const min_tags = moonbitlang$core$array$$Array$map$121$(moonbitlang$core$array$$Array$op_get$80$(nfa.captures, min_code_block), (_param1) => {
        const _x = _param1._1;
        const _begin = _x._0;
        const _end = _x._1;
      ...
      moonbitlang$core$builtin$$Map$set$90$(self.end_nodes, node, { _0: min_code_block, _1: min_tags });
      return;
    } else {
...
function moonbitlang$ulex$lib$automaton$$NFA$get_eps_closure(self) {
  return moonbitlang$core$array$$Array$map$120$(self.graph, (x) => {
    ...
    while (true) {
      if (!moonbitlang$core$queue$$T$is_empty$39$(queue)) {
        ...
        _bind((e) => {
          ...
          if (moonbitlang$core$builtin$$op_notequal$70$(new_u_bits, moonbitlang$core$builtin$$Map$get$38$(result, _u))) {
...
function moonbitlang$ulex$lib$automaton$$from_nfa$46$get_id$124$120(_env, state) {
  const nfa = _env._3;
  const dfa = _env._2;
  const queue = _env._1;
...
function moonbitlang$ulex$lib$automaton$$from_nfa$46$42$func$124$423(_env, _p) {
  const _bind = _env._1;
...
function moonbitlang$ulex$lib$automaton$$from_nfa$46$add_tran$124$144(new_nfa_trans, cset, targets) {
  if (!moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$is_empty(cset)) {
    moonbitlang$core$array$$Array$push$113$(new_nfa_trans, { _0: cset, _1: targets });
    return;
  } else {
    return;
  }
...
function moonbitlang$ulex$lib$automaton$$DFA$from_nfa(nfa) {
  ...
  const captures = moonbitlang$core$array$$Array$map$117$(nfa.captures, (x) => moonbitlang$core$array$$Array$map$118$(x, (y) => y._0));
  ...
  const _env = { _0: node_map, _1: queue, _2: dfa, _3: nfa };
  moonbitlang$ulex$lib$automaton$$from_nfa$46$get_id$124$120(_env, _initial_state);
  while (true) {
    if (!moonbitlang$core$queue$$T$is_empty$21$(queue)) {
      ...
      const from_n = moonbitlang$core$option$$Option$unwrap$5$(moonbitlang$core$builtin$$Map$get$86$(node_map, cur_state));
      const _bind$3 = moonbitlang$core$immut$hashmap$$T$iter$37$(cur_state);
      const char_set_by_nfa_target = moonbitlang$core$builtin$$Map$from_array$91$([]);
      const _p = (nfa_tran) => {
        const _cset = nfa_tran._0;
        const _target = nfa_tran._1;
        const _bind$4 = moonbitlang$core$builtin$$Map$op_get$91$(char_set_by_nfa_target, _target);
        if (_bind$4 === undefined) {
          moonbitlang$core$builtin$$Map$op_set$91$(char_set_by_nfa_target, _target, _cset);
        } else {
          const _Some = _bind$4;
          const _old_cset = _Some;
          moonbitlang$core$builtin$$Map$op_set$91$(char_set_by_nfa_target, _target, moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$op_add(_old_cset, _cset));
        }
        return 1;
      };
      _bind$3((_p$2) => {
        ...
        const _bind$4 = moonbitlang$core$array$$Array$iter$108$(_nfa_node.trans);
        const _env$2 = { _0: _tag_state, _1: _bind$4 };
        return moonbitlang$ulex$lib$automaton$$from_nfa$46$42$func$124$423(_env$2, _p);
      });
      const nfa_trans = { val: [] };
      const all_char_set = { val: moonbitlang$ulex$lib$util$eof_char_set$$empty };
      const _bind$4 = moonbitlang$core$builtin$$Map$iter2$91$(char_set_by_nfa_target);
      _bind$4((target, char_set) => {
        const targets = moonbitlang$core$immut$sorted_set$$singleton$25$(target);
        const new_nfa_trans = [];
        moonbitlang$ulex$lib$automaton$$from_nfa$46$add_tran$124$144(new_nfa_trans, moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$op_sub(char_set, all_char_set.val), targets);
        ...
        while (true) {
          ...
          if (_i < _len) {
            ...
            moonbitlang$ulex$lib$automaton$$from_nfa$46$add_tran$124$144(new_nfa_trans, moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$land(_old_cset, char_set), moonbitlang$core$builtin$$Add$op_add$31$(_old_targets, targets));
            moonbitlang$ulex$lib$automaton$$from_nfa$46$add_tran$124$144(new_nfa_trans, moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$op_sub(_old_cset, char_set), _old_targets);
            _tmp = _i + 1 | 0;
            continue;
          } else {
            break;
      ...
      const next_states = moonbitlang$core$builtin$$Map$new$87$(moonbitlang$core$builtin$$Map$new$46$capacity$46$default$87$());
      const _arr = nfa_trans.val;
      const _len = _arr.length;
      let _tmp = 0;
      while (true) {
        ...
        if (_i < _len) {
          ...
          _bind$5((target) => {
            ...
            const state_map = { val: moonbitlang$core$option$$Option$or_else$21$(moonbitlang$core$builtin$$Map$op_get$87$(next_states, _cset), () => moonbitlang$core$immut$hashmap$$new$37$()) };
            if (moonbitlang$core$option$$Option$is_empty$5$(_tag)) {
              ...
              moonbitlang$core$builtin$$Map$op_set$87$(next_states, _cset, state_map.val);
            } else {
              moonbitlang$core$builtin$$abort$4$("error");
            }
            return 1;
      ...
      const trans = moonbitlang$core$builtin$$Iter$to_array$109$(moonbitlang$core$builtin$$Map$iter$87$(next_states));
      ...
      while (true) {
        ...
        if (_i < _len$2) {
          ...
          const to_n = moonbitlang$ulex$lib$automaton$$from_nfa$46$get_id$124$120(_env, _state$2);
...
function moonbitlang$ulex$lib$automaton$$NFA$add_edge(self, from, s, tag, to) {
  if (s.$tag === 0) {
    ...
    const _EChar = s;
    const _c = _EChar._0;
    moonbitlang$core$array$$Array$push$108$(from.trans, { _0: _c, _1: { _0: to, _1: tag } });
    return;
  }
}
    ...
    case 1: {
      ...
      if (encoding === undefined) {
        ...
        switch (_x) {
          ...
          default: {
            const _bind = moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$iter(_cset);
            _bind((c) => {
              const _bind$2 = moonbitlang$ulex$lib$util$eof_char_set$$EofChar$repr(c);
              if (_bind$2.$tag === 0) {
                ...
                const _Char = _bind$2;
                const _c = _Char._0;
                const bytes = moonbitlang$x$encoding$$encode(0, moonbitlang$core$string$$String$make(1, _c));
                ...
                while (true) {
                  const _i = _tmp;
                  if (_i < _len) {
                    $bound_check(bytes, _i);
                    const byte = bytes[_i];
                    const prev_node$2 = prev_node;
                    const end_node = moonbitlang$ulex$lib$automaton$$NFA$new_node(self);
                    moonbitlang$ulex$lib$automaton$$NFA$add_edge(self, prev_node$2, new $64$moonbitlang$47$ulex$47$lib$47$automaton$46$Input$EChar(moonbitlang$ulex$lib$util$eof_char_set$$singleton(byte)), moonbitlang$ulex$lib$automaton$$NFA$add_edge$46$tag$46$default(), end_node);
                    prev_node = end_node;
                    _tmp = _i + 1 | 0;
                    continue;
                  } else {
...
function moonbitlang$ulex$lib$automaton$$NFA$register_regex(self, node, re, code_block, name2tag) {
  const final_ = moonbitlang$ulex$lib$automaton$$NFA$register_regex_rec(self, node, re, name2tag, undefined);
...
function moonbitlang$ulex$lib$automaton$$NFA$from_rule(rule) {
  ...
  while (true) {
    ...
    if (_i < _len) {
      ...
      const capture_names = moonbitlang$core$array$$Array$map$119$(moonbitlang$ulex$lib$type$$Regex$get_capture_names(_re), (var_) => {
      ...
      const _bind = moonbitlang$core$array$$Array$iter$110$(capture_names);
      const map = moonbitlang$core$builtin$$Map$from_iter$93$((_p) => _bind((_p$2) => {
        const _x = _p$2._0;
        const _name = _x._0;
        const _x$2 = _p$2._1;
      ...
      moonbitlang$ulex$lib$automaton$$NFA$register_regex(nfa, node, _re, _code_block, (x) => moonbitlang$core$option$$Option$unwrap$77$(moonbitlang$core$builtin$$Map$get$93$(map, x)));
      moonbitlang$core$array$$Array$push$80$(nfa.captures, capture_names);
      _tmp = _i + 1 | 0;
      continue;
    } else {
      break;
...
function moonbitlang$ulex$lib$codegen$internal$codeblock_parser$$scan_codeblock_rbrace$128$(subst, lexbuf) {
  let _tmp = subst;
  let _tmp$2 = lexbuf;
  _L: while (true) {
    const subst$2 = _tmp;
        ...
        switch (_bind) {
          ...
          case 26: {
            _L$23: {
              ...
              matched.val = { _0: 2, _1: moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$curr_pos$127$(lexbuf$2), _2: [{ _0: _tag_0.val, _1: _tag_1.val }, { _0: _tag_2.val, _1: _tag_3.val }, { _0: _tag_4.val, _1: _tag_5.val }] };
            }
            moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$next$127$(lexbuf$2);
            state = -1;
            break;
    ...
    if (_bind === undefined) {
      ...
      switch (_pattern_id) {
        case 0: {
          moonbitlang$ulex$lib$codegen$internal$codeblock_parser$$scan_codeblock_rbrace$128$(subst$2, lexbuf$2);
          continue _L;
        }
        case 1: {
          return;
        ...
        case 2: {
          ...
          const __end_pos_of_t2 = _bind$3._1;
          const t2 = moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t2, __end_pos_of_t2);
          const _bind$4 = moonbitlang$core$array$$Array$op_get$77$(__captures, 2);
          const __start_pos_of_t = _bind$4._0;
          const __end_pos_of_t = _bind$4._1;
          moonbitlang$ulex$45$runtime$lexbuf$$Lexbuf$sub_lexeme$127$(lexbuf$2, __start_pos_of_t, __end_pos_of_t);
          let _tmp$3;
          switch (t1) {
            case "startpos": {
          ...
          moonbitlang$core$array$$Array$push$112$(subst$2, { start: __start_pos_of_t, end: __end_pos_of_t, desc: _tmp$3 });
          continue _L;
        }
        case 3: {
          continue _L;
...
function moonbitlang$ulex$lib$codegen$internal$codeblock_parser$$parse_codeblock(str) {
  ...
  const subst = [];
  moonbitlang$ulex$lib$codegen$internal$codeblock_parser$$scan_codeblock_rbrace$128$(subst, lexbuf);
  return subst;
}
function moonbitlang$ulex$lib$codegen$$group_trans$46$42$func$124$198(_env, _p) {
...
function moonbitlang$ulex$lib$codegen$$group_trans(trans) {
  const char_set_by_state = moonbitlang$core$builtin$$Map$from_array$88$([]);
  const tag_action_by_state = moonbitlang$core$builtin$$Map$from_array$89$([]);
  ...
  while (true) {
    ...
    if (_i < _len) {
      ...
      moonbitlang$core$builtin$$Map$op_set$89$(tag_action_by_state, _next_state, _tag_action);
      const _bind = moonbitlang$core$builtin$$Map$op_get$88$(char_set_by_state, _next_state);
      if (_bind === undefined) {
        moonbitlang$core$builtin$$Map$op_set$88$(char_set_by_state, _next_state, _char_set);
      } else {
        const _Some = _bind;
        const _existing_char_set = _Some;
        moonbitlang$core$builtin$$Map$op_set$88$(char_set_by_state, _next_state, moonbitlang$ulex$lib$util$eof_char_set$$EofCharSet$union(_char_set, _existing_char_set));
      }
      _tmp = _i + 1 | 0;
      continue;
    } else {
  ...
  const _bind = moonbitlang$core$builtin$$Map$iter$88$(char_set_by_state);
  const result = moonbitlang$core$builtin$$Iter$to_array$18$((_p) => _bind((_p$2) => {
    const _state = _p$2._0;
    const _char_set = _p$2._1;
    const action = moonbitlang$core$option$$Option$unwrap$105$(moonbitlang$core$builtin$$Map$op_get$89$(tag_action_by_state, _state));
    ...
    return moonbitlang$ulex$lib$codegen$$group_trans$46$42$func$124$198(_env, _p);
  }));
...
function moonbitlang$ulex$lib$codegen$$codegen_rule(rule) {
    ...
    if (_i < _len) {
      ...
      while (true) {
        ...
        if (_i$2 < _len$2) {
          ...
          const _x = tran._1;
          const _tag_action = _x._1;
          const _bind = moonbitlang$core$sorted_map$$T$op_get$48$(tag_action_dedup, _tag_action);
          if (_bind === undefined) {
            const id = next_tag_action_id;
            moonbitlang$core$sorted_map$$T$op_set$48$(tag_action_dedup, _tag_action, id);
            next_tag_action_id = next_tag_action_id + 1 | 0;
          }
          _tmp$2 = _i$2 + 1 | 0;
          continue;
        } else {
  ...
  while (true) {
    ...
    if (_i < _len$4) {
      ...
      const _bind$3 = moonbitlang$core$builtin$$Map$op_get$90$(dfa.end_nodes, _i);
      if (_bind$3 === undefined) {
      } else {
        const _Some = _bind$3;
        const _x = _Some;
      ...
      while (true) {
        ...
        if (_i$2 < _len$5) {
            ...
            if (_i$3 < _len$6) {
              ...
              while (true) {
                ...
                if (_i$4 < _len$7) {
                  ...
                  if (src_rank === -1) {
                    moonbitlang$core$array$$Array$push$6$(buf, `${moonbitlang$core$builtin$$Show$to_string$6$(moonbitlang$ulex$lib$codegen$$codegen_rule$46$gen_tag_var$124$34(_i$3, _i$4))} = lexbuf.curr_pos()`);
                  } else {
                    if (src_rank !== _i$4) {
                      moonbitlang$core$array$$Array$push$6$(buf, `${moonbitlang$core$builtin$$Show$to_string$6$(moonbitlang$ulex$lib$codegen$$codegen_rule$46$gen_tag_var$124$34(_i$3, _i$4))} = ${moonbitlang$core$builtin$$Show$to_string$6$(moonbitlang$ulex$lib$codegen$$codegen_rule$46$gen_tag_var$124$34(_i$3, src_rank))}`);
                    }
                  }
                  _tmp$8 = _i$4 + 1 | 0;
                  continue;
          ...
          if (_bind$4 === undefined) {
            moonbitlang$core$builtin$$Logger$write_string$10$(out, `          ${moonbitlang$core$builtin$$Show$to_string$6$(pattern)} => ${moonbitlang$core$builtin$$Show$to_string$5$(_next_state)}\n`);
          } else {
            const _Some = _bind$4;
      ...
      moonbitlang$core$builtin$$Logger$write_string$10$(out, "          _ => -1\n        }\n      }\n");
      _tmp$5 = _i + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (_i < _len$5) {
      ...
      const _arr$5 = moonbitlang$core$array$$Array$op_get$78$(dfa.captures, _i);
...
function moonbitlang$ulex$lib$codegen$$codegen_lex(lex) {
  ...
  const _lhs = moonbitlang$core$array$$Array$map$116$(lex.rules, moonbitlang$ulex$lib$codegen$$codegen_rule);
...
function Yoorkin$trie$$T$lookup$130$(self, path) {
...
function Yoorkin$trie$$add$46$aux$47$5513(value, _param1, _param2) {
  if (_param1.len === 0) {
    ...
    return { value: _param2.value, forks: moonbitlang$core$immut$sorted_map$$T$add$33$(_param2.forks, _x, Yoorkin$trie$$add$46$aux$47$5513(value, _x$2, subtree)) };
  }
}
function Yoorkin$trie$$T$add$130$(self, path, value) {
  const _bind = moonbitlang$core$string$$String$to_array(path);
  return Yoorkin$trie$$add$46$aux$47$5513(value, { buf: _bind, start: 0, len: _bind.length }, self);
}
function Yoorkin$trie$$empty$130$() {
...
function Yoorkin$ArgParser$$interpret(trie, xs, fallback) {
  ...
  _L: while (true) {
    ...
    if (_param_len === 0) {
      ...
      const _bind$5 = Yoorkin$trie$$T$lookup$130$(trie, _x);
      if (_bind$5 === undefined) {
        fallback(_x);
        _tmp$2 = _bind$3;
        _tmp$3 = _bind$4;
...
function Yoorkin$ArgParser$$parse$46$aux$124$7(_param1, _param2) {
  ...
  const trie = Yoorkin$trie$$T$add$130$(Yoorkin$trie$$T$add$130$(_x, _a, _spec), _b, _spec);
...
function Yoorkin$ArgParser$$parse(speclist, rest, usage_msg, argv) {
  const _bind = moonbitlang$core$array$$Array$fold$124$(speclist, { _0: Yoorkin$trie$$empty$130$(), _1: `${usage_msg}\n options:\n` }, Yoorkin$ArgParser$$parse$46$aux$124$7);
  ...
  const trie = Yoorkin$trie$$T$add$130$(Yoorkin$trie$$T$add$130$(_trie, "--help", help_spec), "-h", help_spec);
...
(() => {
  ...
  if (moonbitlang$core$builtin$$op_notequal$6$(input_file.val, "")) {
    ...
    _L: {
      ...
      moonbitlang$core$builtin$$println$74$(_try_err);
      lex = $panic();
    }
