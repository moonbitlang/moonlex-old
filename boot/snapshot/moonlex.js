...
function jian$mbtlex$lib$codegen$internal$codeblock_parser$$Engine$run(self, lexbuf) {
  ...
  while (true) {
    if (state !== 0) {
      ...
      const next = moonbitlang$core$array$$Array$op_get$48$(moonbitlang$core$array$$Array$op_get$56$(self.graph, state), b);
      state = next._0;
      const new_tagState = [];
      let _tmp$2 = 0;
      while (true) {
...
function Yoorkin$trie$$T$add$117$(self, path, value) {
  return Yoorkin$trie$$add$46$aux$47$2964(value, moonbitlang$core$array$$Array$op_as_view$2$(moonbitlang$core$string$$String$to_array(path), 0, undefined), self);
}
function Yoorkin$trie$$add$46$aux$47$2964(value, _param1, _param2) {
  if (moonbitlang$core$array$$ArrayView$length$2$(_param1) === 0) {
    ...
    return { value: _param2.value, forks: moonbitlang$core$immut$sorted_map$$T$add$21$(_param2.forks, _x, Yoorkin$trie$$add$46$aux$47$2964(value, _x$2, subtree)) };
  }
}
